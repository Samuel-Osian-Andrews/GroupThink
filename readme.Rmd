...
#install.packages("devtools") # ...uncomment this line if needed
library(devtools)
...
You only need to do this once. After that, you can just run `library(GroupThink)` like you would for any other package.
...
For other functionality not covered in this document, please run `?unify()` to view the help file, which covers all possible parameters.
